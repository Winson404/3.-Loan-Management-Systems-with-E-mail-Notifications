<title>List of Loans | LM System </title>
 ...
 <div id="layoutSidenav_content">
    <main>
        ...
        <h4 class="mt-4">List of released loans</h4>
        <div class="card mb-4">
                    ...
                    <table id="datatablesSimple">
                        ...
                        <tbody>
                            <?php
                              $i = 1;
                              include("../config.php");
                              $query =mysqli_query($conn, "SELECT * FROM loan_list JOIN users ON loan_list.borrower_id=users.user_Id WHERE loan_list.status=2");
                             ...
                             ?>
                              <tr>
                                  ...
                                  <td>
                                        ...
                                        <span class="badge bg-primary rounded-pill" data-bs-toggle="modal" type="button" data-bs-target="#paid_loan<?php echo $row['user_Id']; ?>">Released</span>
                                  ...
                                  <?php include 'loan_list_paid.php'; //include 'loan_list_approve.php';  include 'loan_list_release.php'; ?>             
                            </tr>
                            <?php  
