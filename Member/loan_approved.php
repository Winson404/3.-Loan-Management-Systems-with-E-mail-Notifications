<title>Approved Loan | LM System </title>
 <?php 
    include 'sidebar.php';
 ?>
 ...
 <div id="layoutSidenav_content">
    <main>
        ...
        <h4 class="mt-4">My approved application</h4>
        <div class="card mb-4">
                     ...
                     <table id="datatablesSimple">
                        ...
                        <tbody>
                            <?php
                              $i = 1;
                              include("../config.php");
                              $query ="SELECT * FROM loan_list JOIN users ON loan_list.borrower_id=users.user_Id WHERE loan_list.borrower_id='$id' AND loan_list.status=1";
