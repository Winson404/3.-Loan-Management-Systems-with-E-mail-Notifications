        ...
        <div class="row justify-content-center">
            <div class="col-lg-10">
                <div class="card shadow-lg border-0 rounded-lg mt-3">
                    <div class="card-header">
                        <h3 class="text-center font-weight-light my-4">Personal information</h3>                        
                    </div>
                    <div class="card-body">
            <div class="row mb-3">
            ...
            <form action="process_update.php" method="POST">
                ...
                <div class="row mb-3">
                    ...
                    <div class="card-footer text-center d-flex justify-content-end py-3">
                        <a href="about_me.php" class="btn btn-secondary m-1" style="text-decoration: none;"><i class="bi bi-arrow-left-short"></i> Back</a>
                        <button class="btn btn-primary m-1" type="submit" name="update_member"><i class="bi bi-save"></i> Save</button>
                    </div>
                </div>
                 </form>
            </div>
