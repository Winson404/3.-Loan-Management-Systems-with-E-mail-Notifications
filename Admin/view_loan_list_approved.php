<title>List of Loans | LM System </title>
 ...
 <div id="layoutSidenav_content">
    <main>
        ...
        <h4 class="mt-4">List of approved loans</h4>
        <div class="card mb-4">
                ...
                <div class="card-body">
                    <table id="datatablesSimple">
                        ...
                        <tbody>
                            <?php
                              $i = 1;
                              include("../config.php");
                              // $query = mysqli_query($conn, "SELECT * FROM users JOIN loan_list ON users.user_Id=loan_list.borrower_id JOIN loan_types ON loan_list.loan_type_Id=loan_types.loan_Id JOIN loan_plans ON loan_list.plan_Id=loan_plans.plan_Id  WHERE status='1'");
                              // $query =mysqli_query($conn, "SELECT * FROM loan_list JOIN users ON loan_list.borrower_id=users.user_Id LEFT JOIN payment ON loan_list.borrower_id=payment.borrower_Id WHERE status=1");
                              $query =mysqli_query($conn, "SELECT * FROM loan_list JOIN users ON loan_list.borrower_id=users.user_Id WHERE status=1");
                             ...
                             ?>
                              <tr>
                                  ...
                                  <td>
                                        ...
                                        <span class="badge bg-success rounded-pill" data-bs-toggle="modal" type="button" data-bs-target="#release_loan<?php echo $row['user_Id']; ?>">Approved</span>
                                 ...
                                 <!--  <td>
                                  ...
                                  <?php //include 'loan_list_approve.php';
                                    include 'loan_list_release.php'; ?>             
                            </tr>
                            <?php  
                    ...
                    <p><b>NOTE:</b> To update the application status to <b>release</b>, just click the <span class="badge bg-success rounded-pill">appoved</span> status.</p>
                </div>
