                    ...
                    <table id="datatablesSimple">
                        ...
                        <tbody>
                            <?php
                              $i = 1;
                              include("../config.php");
                              $query = mysqli_query($conn, "SELECT * FROM loan_list JOIN users ON loan_list.borrower_id=users.user_Id JOIN loan_types ON loan_list.loan_type_name=loan_types.loan_name WHERE loan_list.status=4");
                             ...
                             ?>
                              <tr>
                                  ...
                                  <td><b><?php echo $row["terms_of_loan"]; ?></b> months - <b><?php echo $row["interest_rate"]; ?>%</b> interest - <b><?php echo $row["monthly_overdue_penalty"]; ?>%</b> weekly overdue penalty
                                  </td>
                                  <td>
