  ...
  <div class="modal-dialog modal-lg modal-dialog-scrollable">
    <div class="modal-content">
      <div class="modal-header bg-light">
        <h5 class="modal-title" id="staticBackdropLabel">Update staff</h5>
      ...
      <div class="modal-footer">
        ...
        <button class="btn btn-primary" type="submit" name="update_employer"><i class="bi bi-save"></i> Update</button>
      </div>
      </form>
    </div>
  </div>
