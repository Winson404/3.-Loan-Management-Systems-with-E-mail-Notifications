            ...
            <div class="col-lg-10">
                <div class="card shadow-lg border-0 rounded-lg mt-3">
                    <div class="card-header text-center">
                        <h3 class=" font-weight-light m-0 pt-3">Personal information</h3>
                        <a class="text-xs" href="#" style="text-decoration: none;">You are currently viewing your information.</a>
                    </div>
                    <div class="card-body">
                    ...
                    <div class="card-footer text-center py-3">
                        <div class="d-flex justify-content-end"><a class="btn btn-primary" href="about_me_update.php">Update</a></div>
                    </div>
                </div>
            </div>
        </div>
