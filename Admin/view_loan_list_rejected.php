<title>List of Loans | LM System </title>
 ...
 <div id="layoutSidenav_content">
    <main>
        ...
        <h4 class="mt-4">List of rejected loans</h4>
        <div class="card mb-4">
                    ...
                    <table id="datatablesSimple">
                        ...
                        <tbody>
                            <?php
                              $i = 1;
                              include("../config.php");
                              $query = mysqli_query($conn, "SELECT * FROM loan_list JOIN users ON loan_list.borrower_id=users.user_Id JOIN loan_types ON loan_list.loan_type_name=loan_types.loan_name WHERE status=3");
                             ...
                             ?>
                              <tr>
                                  ...
                                  <td><?php echo $row['terms_of_loan']; echo ' '; echo 'months'; echo ' - ';  echo $row['interest_rate']; echo ' '; echo ' interest'; echo ' - '; echo $row['monthly_overdue_penalty']; echo ' '; echo ' penalty'; ?>
                                  </td>
                                  <td>
                                        ...
                                        <span class="badge bg-success rounded-pill" data-bs-toggle="modal" type="button" data-bs-target="#re-apply_loan<?php echo $row['user_Id']; ?>">Released</span>


                                        <?php elseif($row['status'] === '3'): ?>
                                        <span class="badge bg-danger rounded-pill" data-bs-toggle="modal" type="button" data-bs-target="#re-apply_loan<?php echo $row['user_Id']; ?>">Denied</span>
                                  ...
                                  <!-- <td>
                                    <span class="badge bg-primary rounded-pill" data-bs-toggle="modal" type="button" data-bs-target="#release_loan<?php //echo $row['user_Id']; ?>">Re-apply</span>
                                  ...
                                  include 'loan_list_re-apply.php'; ?>             
                            </tr>
                            <?php  
