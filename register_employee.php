        ...
        <div class="row justify-content-center">
          ...
          <div class="col-lg-11 mt-5 mt-lg-0 d-flex align-items-stretch rounded p-4 bg-light" style="border:1px solid lightgrey;">
            <form action="processes.php" method="post" enctype="multipart/form-data">
              <div class="row">
                <div class="form-group col-md-4 mb-4">
                  ...
                  <input type="text" class="form-control" id="firstname" name="firstname" required onkeyup="lettersOnly(this)">
                </div>
                <div class="form-group col-md-3 mb-4">
                  <label for="middlename">Middle name</label>
                  <input type="text" class="form-control" id="middlename" name="middlename"required onkeyup="lettersOnly(this)">
                </div>
                <div class="form-group col-md-3 mb-4">
                ...
                <div class="form-group col-md-4 mb-4">
                 ...
                 <div class="form-group col-md-4 mb-4">
                  ...
                  <input type="password" class="form-control" name="password" required id="newpassword">
                ...
                <div class="form-group col-md-4 mb-4">
                  ...
                  <input type="password" class="form-control" name="cpassword"required id="confirmpassword" onkeyup="validate_password()">
            ...
            <!--   <div class="my-3">
              ...
              <div class="text-center mt-3"><button type="submit" class="btn btn-primary" name="register_employer" id="register">Register</button></div>
